...
const fallbackProjects = [
  {
    id: "1",
    title: "E-commerce Dashboard",
    description: "Build a dashboard with analytics.",
    difficulty: "Intermediate",
  ...
  },
  {
    id: "3",
    title: "AI Chat App",
    description: "Build a chatbot interface.",
    difficulty: "Advanced",
    techStack: ["React", "Node.js"],
...
const generateProjectRecommendations = async (userData) => {
  //const cacheKey = `projects-${userData.quizData.averageScore}-${userData.assessmentData.totalAssessments}`;
  const cacheKey = JSON.stringify({
  avg: userData.quizData.averageScore,
  topics: userData.assessmentData.favoriteTopics
});
  // 🟢 1. Check cache first
...
try {
  ...
  console.log("❌ JSON failed → using fallback");
...
if (!Array.isArray(projects)) {
  projects = fallbackProjects;
    ...
    // 🟢 Save to cache
    setCache(cacheKey, projects, 600000);
