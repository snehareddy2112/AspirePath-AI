  ...
  const alumniTestimonials: AlumniTestimonial[] = [
    {
      ...
      story: 'AspirePath AI\'s placement prep and AI Study Buddy helped me crack Google\'s coding interviews. The mock interviews were incredibly helpful!',
      year: 2024,
    ...
    },
    {
      ...
      story: 'The MERN stack roadmap and hands-on projects gave me the confidence to ace technical rounds. Thank you AspirePath AI!',
      year: 2023,
    ...
    },
    {
      ...
      story: 'AspirePath AI\'s interview prep and resume builder were instrumental in helping me land a PM role at Flipkart.',
      year: 2024,
    ...
    },
    {
      ...
      story: 'The AI projects and coding practice helped me build a strong portfolio. Grateful for the journey with AspirePath AI!',
      year: 2023,
          ...
          <div className="mx-auto max-w-7xl text-center">
            ...
            <div className="mb-12 space-y-6">
              ...
              <p className="mx-auto max-w-3xl text-base leading-relaxed text-gray-400 sm:text-lg md:text-xl">
                Discover how AspirePath AI has transformed careers and helped students land their dream jobs at top companies worldwide
              </p>
            </div>
          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div className="mt-16 text-center">
              <p className="mx-auto max-w-2xl text-xl text-gray-400">
                Join thousands of developers who have transformed their careers with AspirePath AI
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-3xl text-xl text-gray-400">
                Real stories from real people who transformed their careers with AspirePath AI
              </p>
            </div>
