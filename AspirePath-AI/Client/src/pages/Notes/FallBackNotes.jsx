...
function FallBackNotes() {
    ...
    if (!subjectData) return (
        <div className={`relative min-h-screen-minus-nav overflow-hidden z-10 ml-64 ${state.darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
    ...
    return (
        <div className={`relative min-h-screen-minus-nav overflow-hidden z-10 ml-64 ${isDark ? 'bg-dark-bg-primary text-dark-text-primary' : 'bg-light-bg-primary text-light-text-primary'}`}>
            {/* Enhanced Background with gradient overlay */}
            <motion.div
                variants={backgroundVariants}
                initial="hidden"
