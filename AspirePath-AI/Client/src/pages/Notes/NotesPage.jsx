...
const NotesPage = () => {
  ...
  return (
    <div
      className={`relative min-h-screen-minus-nav overflow-visible ml-64 ${
              ...
              >
                {filteredAdminNotes.map((note, index) => {
                  ...
                  return (
                    <motion.div
                      key={index}
                      className={`relative group overflow-visible rounded-xl p-6 transition-all transform hover:-translate-y-0.5 ${
                        state.darkMode
