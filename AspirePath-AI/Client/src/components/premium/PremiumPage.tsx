...
const PremiumPage: React.FC = () => {
  ...
  const handleUpgrade = (planName: string) => {
    if (planName === 'Pro') {
      ...
      window.open('mailto:sales@aspirepath.ai?subject=Enterprise Plan Inquiry', '_blank');
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className={`rounded-2xl p-12 text-center ${state.darkMode ? 'bg-gradient-to-r from-gray-800 to-gray-900' : 'bg-gradient-to-r from-blue-50 to-purple-50'}`}>
          ...
          <p className={`text-xl ${state.darkMode ? 'text-gray-300' : 'text-gray-600'} mb-8 max-w-2xl mx-auto`}>
            Join thousands of developers who have accelerated their careers with AspirePath AI Pro.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => window.open('mailto:sales@aspirepath.ai?subject=Enterprise Plan Inquiry', '_blank')}
