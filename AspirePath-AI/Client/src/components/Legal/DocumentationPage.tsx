        ...
        <div className="px-4 py-8 space-y-8 min-h-screen text-gray-800 bg-gray-50 dark:bg-gray-900 dark:text-gray-200 sm:px-6 sm:py-12 sm:space-y-12">
            ...
            >
                ...
                <p className="mb-4 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    AspirePath-AI follows a modular monorepo structure with separate frontend and backend directories. Below is the combined architecture overview.
                </p>
...
npm run dev   # Runs on http://localhost:5173`}
            ...
            >
                ...
                <p className="mb-4 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    AspirePath AI welcomes contributions! Follow strict guidelines: No changes to core backend/routes/auth. Always pull latest main, add PR comments with files edited/testing steps/screenshots.
                </p>
