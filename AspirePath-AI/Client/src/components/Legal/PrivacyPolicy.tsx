    ...
    <div className="transition-colors duration-200">
      <div className="px-4 py-12 mx-auto max-w-4xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            At AspirePath AI, we are committed to protecting your privacy and
            ensuring the security of your personal information. This Privacy
            Policy outlines how we collect, use, store, and protect your data
            when you use our AI-powered education and career advancement
            platform. We believe in transparency and want you to understand
